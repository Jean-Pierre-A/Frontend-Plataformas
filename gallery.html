...
<title>Bike Race A Sports Category Flat Bootstrap Responsive  Website Template | Gallery :: w3layouts</title>
...
<nav class="navbar navbar-default navbar-fixed-top" data-aos="flip-up">
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <li class="active current"><a id="gallery.html" href="javascript:void(0);">Galeria</a></li>
...
<section class="inner-w3ls">
    <div class="container">
		<h3 class="text-center" data-aos="zoom-in">Nuestra Galeria</h3>
...
<!-- //images -->
<!-- video -->
<section class="video-w3ls">
	<div class="container">
		<h3 class="text-center" data-aos="flip-up">Nuestros videos</h3>
		<div class="carousel right">
			<div class="indicator"></div>
			<div class="wrap" data-aos="flip-up">
				<ul>
					<li><a class="bla-2" href="https://www.youtube.com/watch?v=stwfs1hlmwk"><span class="container2"><img src="images/videopic1.jpg" alt="w3layouts"/></span></a></li>
					<li><a class="bla-2" href="https://vimeo.com/29764755"><span class="container2"><img src="images/videopic2.jpg" alt="w3layouts"/></span></a></li>
					<li><a class="bla-2" href="https://www.youtube.com/watch?v=stwfs1hlmwk"><span class="container2"><img src="images/videopic3.jpg" alt="w3layouts"/></span></a></li>
					<li><a class="bla-2" href="https://vimeo.com/29764755"><span class="container2"><img src="images/videopic4.jpg" alt="w3layouts"/></span></a></li>
					<li><a class="bla-2" href="https://www.youtube.com/watch?v=stwfs1hlmwk"><span class="container2"><img src="images/videopic5.jpg" alt="w3layouts"/></span></a></li>
					<li><a class="bla-2" href="https://vimeo.com/29764755"><span class="container2"><img src="images/videopic6.jpg" alt="w3layouts"/></span></a></li>
					<li><a class="bla-2" href="https://www.youtube.com/watch?v=stwfs1hlmwk"><span class="container2"><img src="images/videopic7.jpg" alt="w3layouts"/></span></a></li>
				</ul>
			</div>
		</div>
	</div>
...
<section class="last-w3layouts">
	<div class="container">
		<a href="index.html" class="bottom-agile"><h2 class="text-center">Moto de Carreras</h2></a>
