	...
	<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6" data-aos="flip-right">
                <h3>Creación</h3>
                <p>Esta Pagína fue diseñada con fines educativos por estudiantes de la Universidad pontificia bolivariana, el objetivo era crear una pagina 
					que sirviera como fuente de información y recomendaciones para cualquier persona que tenga un vehículo o piensa adquirirlo. <br>
					
					
				</p>
				<p>Link a los repositorios de github de cada colaborador:</p>
				<a class="a-github" href="https://github.com/Nicobelicko">
				Juan Nicolás Ruiz Muñoz
			</a>
			<br>
			<br>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Juan Nicolas Ruiz Muñoz</h4>
				</div>
				<div class="modal-body">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<p>Soy un estudiante de ingenieria en sistemas e informática, actualmente cursando el 5to semestre en la Universidad Pontificia Bolivariana de Colombia. Cuando no me dedico al estudio hago ejercicio en un gimnasio y indago sobre temas que me llaman la atención.</p> 
